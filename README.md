...
![Category Sales Ranking](Screenshots/Category_Sales_Ranking.png)
- Sales distribution by product category
- Identifies top- and low-performing categories

### 2️⃣ Monthly Sales Performance
![Monthly Sales Performance](Screenshots/Monthly_Sales_Performance.png)
- Month-wise sales trend analysis
- Helps detect seasonality and performance spikes

### 3️⃣ Customer Contribution Analysis
![Customer Contribution Analysis](Screenshots/Customer_Contribution_Analysis.png)
...
![Scenario Based Analysis](Screenshots/Scenario_Based_Analysis.png)
...
![Customer Classification Analysis](Screenshots/Customer_Classification_Analysis.png)
